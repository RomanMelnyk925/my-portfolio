    ...
    <div className="mt-5">
      ...
      <VerticalTimeline>
        ...
        <VerticalTimelineElement
          ...
          icon={<DiAndroid />}
        >
          <h3 className="vertical-timeline-element-title">Android</h3>
        </VerticalTimelineElement>
        ...
        <VerticalTimelineElement
          ...
          icon={<DiSwift />}
        >
          <h3 className="vertical-timeline-element-title">Swift</h3>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentStyle={{ background: "rgb(78 22 112)", color: "#fbd9ad" }}
          ...
          icon={<DiApple />}
        >
          <h3 className="vertical-timeline-element-title">IOS</h3>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentStyle={{ background: "rgb(78 22 112)", color: "#fbd9ad" }}
        ...
        <VerticalTimelineElement
          ...
          icon={<DiLaravel />}
        >
          <h3 className="vertical-timeline-element-title">Laravel</h3>
        </VerticalTimelineElement>
